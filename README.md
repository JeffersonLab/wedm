# wedm [![Java CI with Gradle](https://github.com/JeffersonLab/wedm/actions/workflows/ci.yml/badge.svg)](https://github.com/JeffersonLab/wedm/actions/workflows/ci.yml)  [![Docker](https://img.shields.io/docker/v/slominskir/wedm?sort=semver&label=DockerHub)](https://hub.docker.com/r/slominskir/wedm)
