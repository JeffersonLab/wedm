            ...
            switch (tokens[0]) {
              case "static":
                ...
                if (firstQuote != -1) {
                  ...
                  String splicedLine =
                      line.substring(0, firstQuote) + "colorname" + line.substring(secondQuote + 1);
              ...
              case "rule":
                ...
                // We convert EDL Color rules into JavaScript case statements with A = input and B =
                // output
                ...
                if (firstQuote != -1) {
                  int secondQuote =
                      firstQuote + secondval.substring(firstQuote + 1).indexOf("\"") + 1;
                ...
                if ("default".equals(condition)) {
                  ...
                  condition = condition.replace("||", "|| A");
                  // Must wait until we have varibles in place to do following as "=" replace must
                  // be preceded by something
                  condition = convertEDMExpressionToJavaScript(condition);
                }
                String colorValue = stripQuotes(secondval);
                expression = expression + condition + "B = '" + colorValue + "'; break;";
