...
public class ActiveButton extends TextScreenObject {
  ...
  public Boolean push =
      null; // default is different for different widgets!  ActiveButton is false while
  // ActiveMessageButton is true.
  ...
  public void parseTraits(Map<String, String> traits, ScreenProperties properties) {
    ...
    if (traits.get("buttonType")
        != null) { // ActiveButton looks for buttonType: "push" and has default of toggle
